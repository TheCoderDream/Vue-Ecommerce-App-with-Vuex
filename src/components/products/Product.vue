<template>
    <div class="card h-100 product">
        <router-link  class="product__link" :to="`/products/${product.id}`"><img
        ...
        <div class="card-body product__text">
            ...
            <button
                    ...
                    class="btn btn-info product__add-to-cart">Add to cart
            </button>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            calculateOffSetLeftAndTop() {
                const offSetTopAndLeft = cumulativeOffset(this.$refs.productImageContainer);
